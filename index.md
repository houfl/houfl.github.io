...
Linux运维之硬件篇
----------------------
![image](https://cdn.jsdelivr.net/gh/houfl/boketuchuang//linuxtu笔记本1111.png)
图-台式机电脑
笔记本电脑介绍
-----------------
...
![image](https://github.com/houfl/houfl.github.io/blob/main/images/主机内部结构.png)
...
![image](https://github.com/houfl/houfl.github.io/blob/main/images/硬件组成部分.png)
...
运维人员的工作内容
日常服务器维护、处理紧急故障。
服务器日常监控 zabbix 监控服务 进程 nagions 运营商 BAT常用 交换机路由器 cacti 流量
业务代码上线。
完成项目:备份、迁移、升级等。
...
![image](https://github.com/houfl/houfl.github.io/blob/main/images/服务器外观.png)
...
![image](https://github.com/houfl/houfl.github.io/blob/main/images/机架式服务器.png)
...
![image](https://github.com/houfl/houfl.github.io/blob/main/images/塔式服务器.png)
...
![image](https://github.com/houfl/houfl.github.io/blob/main/images/Dell R720.png)
Dell R720

加上盖子。

![image](https://github.com/houfl/houfl.github.io/blob/main/images/加上盖子.png)


Dell R6415

![image](https://github.com/houfl/houfl.github.io/blob/main/images/Dell R6415.png)

Dell R740

![image](https://github.com/houfl/houfl.github.io/blob/main/images/Dell R740.png)


Dell R7425

![image](https://github.com/houfl/houfl.github.io/blob/main/images/Dell R7425.png)
...
![image](https://github.com/houfl/houfl.github.io/blob/main/images/图-服务器内部结构.png)
...
![image](https://github.com/houfl/houfl.github.io/blob/main/images/图-服务器CPU外形示例.png)
![image](https://github.com/houfl/houfl.github.io/blob/main/images/CPU处理器.png)
...
![image](https://github.com/houfl/houfl.github.io/blob/main/images/图-服务器CPU风扇.png)
...
https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=1225301118,738918895&fm=26&gp=0.jpg
...
例如：周末了，你在家中休息，想听歌，打开你的电脑或者手机，打开电脑中的音乐播放软件（比如酷狗，QQ音乐等），这个音乐播放软件，在这里我们可以称他为程序，只要打开了软件，不管你是否在播放歌曲，这个打开了的软件程序就是进程，软件一直打开不关闭或者软件最小化放在后台，那么他就是守护进程。

企业案例：提升用户体验的网站解决方案

1.门户（大网站 ）极端案例：大并发写入案例（例如：过年抢红包、淘宝的双十一、电商的促销活动）
...
①.在服务器主板上安装蓄电池，在断电后宕机前的瞬间把内存数据写回到磁盘。
...
通过上图不难发现, CPU处理速度最快，其次是内存,最慢的就是硬盘和网卡了。通过这张图可以了解不同的设备性能差距，将来做运维工作的时候，可从速度慢、瓶颈大的方向进行优化。
...
https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=3113681982,4076383704&fm=26&gp=0.jpg
